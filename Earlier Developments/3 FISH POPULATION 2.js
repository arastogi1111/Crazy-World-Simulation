...
for(var i = 0; i< vehicles.length; i++){
  ...
  if(vehicles[i].health<-1)
   { createP(vehicles[i].foodcount+"        &nbsp  &nbsp &nbsp          " + vehicles[i].poisoncount + "   &nbsp &nbsp &nbsp &nbsp " + vehicles[i].id + "    &nbsp &nbsp DNA : "+ vehicles[i].dna[0] + "     " + vehicles[i].dna[1] + "    " + vehicles[i].maxSpeed + "    "+ vehicles[i].maxForce + "   &nbsp &nbsp &nbsp &nbsp  : " +vehicles[i].blackcount);
    vehicles.splice(i,1)}
}
...
function Vehicle(x,y,i){
  ...
  this.dna= [];
  this.dna[0]= random(0,2);   //GoodMult
  this.dna[1]= random(-2,0);  //BadMult
